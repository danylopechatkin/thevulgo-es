      ...
      {CATEGORY_OPTIONS.map((option) => {
        ...
        return (
          <button
            ...
            className={`group w-[70vw] max-w-[300px] min-h-[210px] shrink-0 snap-start rounded-2xl border p-5 text-left shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition-all duration-200 ${
              active
