...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isEs
    ? "Manitas en Russafa Valencia | Reparaciones y Montaje | THEVULGO"
    : "Handyman in Russafa Valencia | Repairs & Installations | THEVULGO";

  const description = isEs
    ? "Servicio de manitas en Russafa Valencia. Montaje de TV, muebles IKEA, estanterías, lámparas, enchufes, pladur, pequeñas reparaciones y mantenimiento."
    : "Handyman service in Russafa Valencia. TV mounting, IKEA furniture assembly, shelves, lights, outlets, drywall, small repairs and maintenance.";
  ...
  return {
    ...
    keywords: isEs
      ? [
          "manitas russafa",
          "manitas ruzafa",
          "manitas russafa valencia",
          "handyman russafa",
          "reparaciones russafa",
          "montaje tv russafa",
          "montaje muebles russafa",
          "instalar lampara russafa",
          "pladur russafa",
          "manitas valencia",
        ]
      : [
          "handyman russafa",
          "handyman ruzafa",
          "handyman russafa valencia",
          "home repairs russafa",
          "tv mounting russafa",
          "furniture assembly russafa",
          "light installation russafa",
          "drywall repair russafa",
          "handyman valencia",
        ],
    robots: {
      index: true,
...
export default async function HandymanRussafaPage({ params }: Props) {
  const { locale } = await params;
  const isEs = locale === "es";
  ...
  const whatsappText = encodeURIComponent(
    isEs
      ? "Hola, necesito un manitas en Russafa Valencia. Quiero pedir presupuesto para una reparación, montaje o instalación."
      : "Hi, I need a handyman in Russafa Valencia. I’d like to request an estimate for a repair, assembly or installation."
  );
  ...
  const moneyLinks = [
    {
      title: isEs ? "Montaje de TV en Russafa" : "TV mounting in Russafa",
      desc: isEs
  ...
  const detailedServices = isEs
    ? [
        ...
        {
          title: "Pisos, bares y alquileres",
          items: [
    ...
    : [
        ...
        {
          title: "Apartments, bars and rentals",
          items: [
  ...
  const process = isEs
    ? [
        ["1. Envía fotos", "Muestra el trabajo por WhatsApp con fotos, medidas y ubicación en Russafa."],
    ...
    : [
        ["1. Send photos", "Show the job by WhatsApp with photos, measurements and Russafa location."],
  ...
  const faqs = isEs
    ? [
        {
          q: "¿Cuánto cuesta un manitas en Russafa?",
        ...
        },
        {
          ...
          a: "Sí. Envía fotos, medidas, ubicación en Russafa y una breve descripción. Así podemos preparar herramientas, materiales y una estimación más clara.",
        },
        {
          q: "¿Hacéis trabajos pequeños el mismo día?",
          a: "Cuando hay disponibilidad, sí. Para trabajos urgentes o rápidos en Russafa, envía fotos y ubicación por WhatsApp.",
        },
        {
        ...
        {
          q: "¿Hacéis trabajos para bares o pequeños negocios?",
          a: "Sí. Podemos ayudar con estanterías, TV, lámparas, pequeños arreglos, puertas, accesorios y mantenimiento básico.",
        },
        {
        ...
        {
          q: "¿Montáis TV en pared en Russafa?",
    ...
    : [
        {
          q: "How much does a handyman in Russafa cost?",
        ...
        },
        {
          ...
          a: "Yes. Send photos, measurements, Russafa location and a short description so we can prepare tools, materials and a clearer estimate.",
        },
        {
          q: "Do you do same-day small jobs?",
          a: "When availability allows, yes. For urgent or quick jobs in Russafa, send photos and location by WhatsApp.",
        },
        {
        ...
        {
          q: "Do you work with bars or small businesses?",
          a: "Yes. We can help with shelves, TVs, lights, small repairs, doors, accessories and basic maintenance.",
        },
        {
        ...
        {
          q: "Do you mount TVs on walls in Russafa?",
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "Service",
        "@id": `${pageUrl}#service`,
        name: isEs ? "Manitas en Russafa Valencia" : "Handyman in Russafa Valencia",
        serviceType: isEs ? "Servicio de manitas" : "Handyman services",
        provider: {
          "@id": `${baseUrl}/#localbusiness`,
        },
        areaServed: ["Russafa", "Ruzafa", "Valencia"],
        url: pageUrl,
        description: isEs
          ? "Servicio de manitas en Russafa Valencia para montaje de TV, muebles, lámparas, enchufes, estanterías, pladur, pequeñas reparaciones, baño, cocina, Airbnb, bares y mantenimiento."
          : "Handyman service in Russafa Valencia for TV mounting, furniture, lights, outlets, shelves, drywall, small repairs, bathroom, kitchen, Airbnb, bars and maintenance.",
        hasOfferCatalog: {
          "@type": "OfferCatalog",
          name: isEs ? "Servicios de manitas en Russafa" : "Handyman services in Russafa",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            "@type": "ListItem",
            position: 3,
            name: isEs ? "Manitas Russafa" : "Handyman Russafa",
            item: pageUrl,
          },
        ],
      },
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
          <div className="max-w-5xl">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-yellow-400 bg-white px-4 py-2 text-sm font-semibold shadow-sm">
              ...
              THEVULGO • Russafa Valencia
            </div>

            <h1 className="text-4xl font-black tracking-tight sm:text-6xl">
              {isEs
                ? "Manitas en Russafa Valencia para reparaciones, montaje e instalaciones"
                : "Handyman in Russafa Valencia for repairs, assembly and installations"}
            </h1>

            <p className="mt-6 max-w-4xl text-lg leading-8 text-neutral-700">
              {isEs
                ? "Servicio de manitas en Russafa para trabajos reales del día a día: montar una TV, instalar estanterías, montar muebles IKEA, cambiar un enchufe, colgar una lámpara, reparar pladur, ajustar puertas o resolver varias tareas pequeñas en una sola visita."
                : "Handyman service in Russafa for real everyday jobs: mounting a TV, installing shelves, assembling IKEA furniture, replacing an outlet, hanging a light, repairing drywall, adjusting doors or solving several small tasks in one visit."}
            </p>
              ...
              {[
                {
                  ...
                  text: isEs ? "Envía fotos de tu vivienda en Russafa y recibe estimación." : "Send photos from Russafa and get an estimate.",
                },
                {
                  icon: ShieldCheck,
        ...
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-yellow-400 bg-yellow-50 px-4 py-1 text-xs font-bold">
              ...
              {isEs ? "Servicios en Russafa" : "Services in Russafa"}
            </div>

            <h2 className="mt-4 text-3xl font-black sm:text-4xl">
              {isEs ? "Servicios de manitas en Russafa" : "Handyman services in Russafa"}
            </h2>

            <p className="mt-4 max-w-4xl text-neutral-700 leading-8">
              {isEs
                ? "Russafa es una de las zonas más activas de Valencia, con pisos, apartamentos turísticos, bares, restaurantes, oficinas pequeñas y locales que necesitan mantenimiento práctico. THEVULGO ayuda con montaje, reparaciones, instalaciones y pequeños arreglos sin complicar el trabajo."
                : "Russafa is one of Valencia’s most active areas, with apartments, tourist rentals, bars, restaurants, small offices and units that need practical maintenance. THEVULGO helps with assembly, repairs, installations and small fixes without overcomplicating the job."}
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr]">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black sm:text-4xl">
                {isEs
                  ? "Presupuesto claro para trabajos en Russafa"
                  : "Clear estimate for jobs in Russafa"}
              </h2>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-4 max-w-5xl text-3xl font-black sm:text-4xl">
            {isEs
              ? "Trabajos de manitas para pisos, alquileres, bares y negocios en Russafa"
              : "Handyman jobs for apartments, rentals, bars and businesses in Russafa"}
          </h2>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black sm:text-4xl">
                {isEs ? "Por qué elegir THEVULGO en Russafa" : "Why choose THEVULGO in Russafa"}
              </h2>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-yellow-400 bg-white px-4 py-1 text-xs font-bold">
                ...
                {isEs ? "Alquileres y negocios" : "Rentals and businesses"}
              </div>

              <h2 className="mt-4 text-3xl font-black sm:text-4xl">
                {isEs
                  ? "Mantenimiento para pisos, bares y negocios en Russafa"
                  : "Maintenance for apartments, bars and businesses in Russafa"}
              </h2>

              <p className="mt-5 text-lg leading-8 text-neutral-700">
                {isEs
                  ? "Russafa tiene muchos pisos turísticos, bares, restaurantes y locales donde los pequeños problemas deben resolverse rápido: una puerta que no cierra, una lámpara suelta, un enchufe roto, una manilla floja, una balda caída o una pared dañada."
                  : "Russafa has many tourist apartments, bars, restaurants and units where small issues need to be solved quickly: a door that does not close, a loose light, a broken outlet, a loose handle, a fallen shelf or a damaged wall."}
              </p>
            </div>
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr]">
          <div className="rounded-3xl border border-yellow-300 bg-white p-8 shadow-xl">
            ...
            <h2 className="mt-5 text-3xl font-black">
              {isEs ? "Fijaciones seguras en paredes de Russafa" : "Secure fixings on Russafa walls"}
            </h2>
          ...
          <div className="rounded-3xl border border-yellow-300 bg-white p-8 shadow-xl">
            ...
            <p className="mt-4 text-lg leading-8 text-neutral-700">
              {isEs
                ? "Si tienes varias cosas pendientes en Russafa, es mejor enviarlas todas juntas: una lámpara, una estantería, un mueble, una puerta, una reparación de pared o un accesorio de baño."
                : "If you have several pending jobs in Russafa, it is better to send them all together: a light, a shelf, furniture, a door, a wall repair or a bathroom accessory."}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-neutral-200 bg-neutral-50">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="mx-auto mt-4 max-w-5xl text-3xl font-black sm:text-4xl">
              {isEs ? "Manitas cerca de Russafa" : "Handyman near Russafa"}
            </h2>
          </div>
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-yellow-400 bg-yellow-50 px-4 py-1 text-xs font-bold">
              ...
              SEO • handyman Russafa
            </div>

            <h2 className="mt-4 text-3xl font-black sm:text-4xl">
              {isEs
                ? "Servicio de manitas en Russafa Valencia"
                : "Handyman service in Russafa Valencia"}
            </h2>
            ...
            <div className="mt-6 space-y-5 text-lg leading-8 text-neutral-700">
              {isEs ? (
                <>
                  <p>
                    Si buscas <strong>manitas en Russafa Valencia</strong>,
                    THEVULGO ofrece ayuda práctica para trabajos pequeños y
                    medianos en viviendas, apartamentos turísticos, bares,
                    restaurantes, oficinas y pequeños negocios.
                  </p>
                ...
                <>
                  <p>
                    ...
                    <strong>handyman in Russafa Valencia</strong>, THEVULGO
                    offers practical help for small and medium jobs in homes,
                    tourist apartments, bars, restaurants, offices and small
                    businesses.
                  </p>
            ...
            <div className="mt-6 space-y-4">
              {(isEs
                ? [
                    ...
                    "Indica dirección o zona de Russafa",
                ...
                : [
                    ...
                    "Mention address or area in Russafa",
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_0.7fr] lg:items-center">
            <div>
              <h2 className="text-3xl font-black sm:text-4xl">
                {isEs ? "¿Necesitas un manitas en Russafa?" : "Need a handyman in Russafa?"}
              </h2>
