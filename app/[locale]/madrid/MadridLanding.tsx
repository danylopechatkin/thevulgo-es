      ...
      <section className="relative overflow-hidden border-b border-yellow-200 bg-[radial-gradient(circle_at_top_right,_#fef08a_0,_#fff_42%)]">
        <div className="mx-auto max-w-7xl px-4 py-14 sm:py-20">
          ...
          <div className="max-w-4xl">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-yellow-300 bg-yellow-100 px-4 py-2 text-sm font-extrabold"><MapPin className="h-4 w-4" /> Madrid capital · 21 distritos</div>
            <h1 className="text-4xl font-black tracking-tight sm:text-6xl">{title}</h1>
            <p className="mt-6 max-w-3xl text-lg leading-8 text-neutral-700">
              {isEs
                ? `${serviceName} con presupuesto claro, comunicación rápida y trabajo limpio. Atendemos viviendas, pisos de alquiler, oficinas y pequeños negocios en Madrid.`
                : `${serviceName} with clear pricing, fast communication and clean work. We serve homes, rental apartments, offices and small businesses across Madrid.`}
            </p>
            ...
            <div>
              ...
              <div className="mt-8 space-y-5">
                {[
                  ...
                  isEs ? "Acordamos precio y horario antes de la visita en Madrid." : "We agree the price and time before the Madrid visit.",
