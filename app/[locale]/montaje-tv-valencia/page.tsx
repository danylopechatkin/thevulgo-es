...
const faqsEn = [
  {
    q: "How much does TV mounting cost in Valencia?",
    a: "Standard TV mounting in Valencia costs €49. The final price depends on the TV size, bracket, wall type, cable concealment and whether a new electrical outlet is needed.",
  },
  {
    q: "Can you install large 65, 75, 85 or 98 inch TVs?",
    a: "Yes. We install large TVs after checking the wall type, TV weight, suitable bracket and installation safety.",
  },
  {
    q: "Can you mount a TV on drywall?",
    a: "Yes. We can mount TVs on drywall using suitable fixings or locating the internal structure when necessary. We inspect the wall before drilling.",
  },
  {
    q: "Can you hide the TV cables?",
    a: "Yes. We can organise cables with external trunking or assess a cleaner solution based on the wall, outlet position and distance to devices.",
  },
  {
    q: "Do you install Samsung Frame TVs?",
    a: "Yes. We install Samsung Frame TVs, including the bracket, accurate levelling and One Connect cable planning for the available space.",
  },
  {
    q: "Can you supply the TV bracket?",
    a: "Yes. We can help you choose a fixed, tilting or full-motion bracket, and can purchase and bring it on the installation day.",
  },
  {
    q: "How long does TV mounting take?",
    a: "A standard installation usually takes 45 to 90 minutes. Cable concealment, a difficult wall or electrical work may take longer.",
  },
  {
    q: "Do you work outside Valencia city?",
    a: "Yes. We work in Valencia and nearby areas including Mislata, Burjassot, Paterna, Torrent, Sagunto, Cullera and Gandía.",
  },
];
...
export default async function TvMountingValenciaPage({ params }: PageProps) {
  ...
  const catalog = getCatalogServices("TV Mounting");
  const baseIds = new Set(["tv-small", "tv-medium"]);
  const extraIds = new Set(["soundbar", "shelf", "raceway"]);
  const calculatorOptions = catalog
    .filter((item) => baseIds.has(item.id) || extraIds.has(item.id))
    .map((item) => ({
      id: item.id,
      label: isEs ? item.labelEs : item.label,
      price: item.price,
      kind: baseIds.has(item.id) ? ("base" as const) : ("extra" as const),
    }));
    ...
    <main className="bg-white text-neutral-950">
      ...
      <section className="relative overflow-hidden border-b border-yellow-200 bg-gradient-to-br from-yellow-50 via-white to-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 md:grid-cols-2 md:px-8 md:py-24">
          <div>
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-yellow-300 bg-yellow-100 px-4 py-2 text-sm font-black text-neutral-900 shadow-sm">
              ...
              {isEs
                ...
                : "Professional service in Valencia"}
            </div>

            <h1 className="text-4xl font-black tracking-tight md:text-6xl">
              {isEs ? "Montaje de TV" : "TV Mounting"}{" "}
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-neutral-700">
              {isEs ? (
                <>
                  ...
                  <strong className="text-neutral-950">49 €</strong>. Soportes
                  fijos, inclinables o articulados, gestión de cables, montaje
                  de TVs grandes y acabado limpio sin sorpresas.
                </>
              ) : (
                <>
                  Professional wall-mounted TV installation for{" "}
                  <strong className="text-neutral-950">€49</strong>. Fixed,
                  tilting or full-motion brackets, cable management, large TVs
                  and a clean finish.
                </>
              )}
            </p>
            ...
            <div className="mt-8 grid gap-3 text-sm font-semibold text-neutral-700 sm:grid-cols-2">
              {(isEs
                ...
                : [
                    "Installation for €49",
                    "Fixed or full-motion brackets",
                    "Cable concealment",
                    "Large TVs and Samsung Frame",
                    "Clean and tidy work",
          ...
          <TvMiniCalculator locale={locale} options={calculatorOptions} />
        </div>
      </section>
            ...
            : [
                {
                  ...
                  text: "We choose suitable fixings for the wall and weight.",
                },
                {
                  icon: Wrench,
                  title: "Clean work",
                  text: "Accurate levelling, careful drilling and a tidy finish.",
                },
                {
                  icon: Cable,
                  title: "Organised cables",
                  text: "Trunking, cable management or a tailored solution.",
                },
                {
                  icon: Star,
                  title: "Clear price",
                  text: "A quote before work begins. No surprises.",
                },
              ]
          ).map((item) => (
            <div
      ...
      <section className="mx-auto max-w-4xl px-5 py-10 md:px-8">
        <h2 className="text-3xl font-black tracking-tight md:text-4xl">
          {isEs
            ...
            : "Professional TV mounting in Valencia"}
        </h2>
        ...
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {(isEs
              ...
              : [
                  "Wall and position check",
                  "Accurate measuring and levelling",
                  "Bracket installation",
                  "Secure TV mounting",
                  "Basic cable organisation",
                  "Final stability check",
                  "Basic area clean-up",
                  "Advice on ideal height",
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {(isEs
            ...
            : [
                {
                  title: "Fixed bracket",
                  text: "The cleanest and most economical option when you want the TV close to the wall and do not need to move it.",
                },
                {
                  title: "Tilting bracket",
                  text: "A good option for bedrooms or slightly higher installations because the screen can be tilted.",
                },
                {
                  title: "Full-motion bracket",
                  text: "Lets you move, turn and pull the TV away from the wall. Ideal for corners and rooms with several viewing angles.",
                },
              ]
          ).map((item) => (
            <div
      ...
      <section className="mx-auto max-w-7xl px-5 py-10 md:px-8">
        <div className="grid gap-6 md:grid-cols-4">
          {(isEs
            ...
            : [
                {
                  title: "Cable and outlet concealment",
                  text: "We install trunking or find the best solution for a cleaner result.",
                },
                {
                  title: "Samsung Frame installation",
                  text: "Precise levelling and One Connect cable planning for a picture-like finish.",
                },
                {
                  title: "Large TVs from 65–98 inches",
                  text: "We check the wall, weight and bracket so your large TV is secure.",
                },
                {
                  title: "We can also help with",
                  text: "Outlets, soundbars, HDMI, routers, consoles and set-top boxes.",
                },
              ]
          ).map((item) => (
            <div
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 md:px-8">
        <h2 className="text-3xl font-black">
          {isEs
            ...
            : "Which wall types do we mount on?"}
        </h2>
        ...
        <p className="mt-8 text-lg leading-8 text-neutral-700">
          {isEs
            ? "Si no sabes qué tipo de pared tienes, puedes enviarnos una foto o un vídeo por WhatsApp. También podemos revisar la pared en persona antes de elegir la mejor solución."
            : "If you are unsure which wall type you have, send us a photo or video on WhatsApp. We can also inspect the wall in person before choosing the best solution."}
        </p>
      </section>
      ...
      <section className="bg-yellow-400 py-16 text-black">
        <div className="mx-auto max-w-4xl px-5 text-center md:px-8">
          ...
          <p className="mt-6 text-lg font-medium leading-8 text-neutral-900">
            {isEs
              ? "El precio estándar es de 49 €. El coste final puede variar si necesitas soporte incluido, instalación de TV grande, ocultación de cables, trabajo eléctrico, canaleta o montaje especial."
              : "The standard price is €49. The final cost may vary if you need a bracket supplied, a large TV installation, cable concealment, electrical work, trunking or a specialist installation."}
          </p>

          <div className="mt-8 rounded-3xl border border-yellow-600/30 bg-white p-6 text-left shadow-xl">
            <h3 className="text-xl font-black">
              {isEs ? "El precio depende de:" : "The price depends on:"}
            </h3>
          ...
          >
            {isEs
              ...
              : "Send photos and request a price"}
            <ArrowRight className="ml-2 h-5 w-5" />
          </a>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-neutral-700">
          {isEs
            ? "Realizamos montaje de TV en Valencia ciudad y alrededores. Si estás fuera de Valencia, envíanos tu dirección y te confirmamos disponibilidad."
            : "We provide TV mounting in Valencia city and nearby areas. If you are outside Valencia, send us your address so we can confirm coverage."}
        </p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          {(isEs
            ? [
                {
                  title: "Instalación de soporte TV",
            ...
            : [
                ...
                {
                  title: "Samsung Frame mounting",
                  href: `/${locale}/montaje-tv-samsung-frame-valencia`,
                },
                {
                  title: "Hide TV cables",
                  href: `/${locale}/ocultar-cables-valencia`,
                },
                {
        ...
        <div className="mx-auto max-w-4xl px-5 text-center md:px-8">
          <h2 className="text-4xl font-black tracking-tight">
            {isEs
              ...
              : "Ready to mount your TV in Valencia?"}
          </h2>
          <p className="mt-5 text-lg font-medium text-neutral-900">
            {isEs
              ? "Envíanos una foto de la pared, el tamaño de la TV y tu zona. Te damos un presupuesto claro antes de empezar."
              : "Send us a photo of the wall, your TV size and your area. We will provide a clear quote before work begins."}
          </p>
