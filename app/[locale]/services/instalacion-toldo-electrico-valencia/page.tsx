...
const slug = "services/instalacion-toldo-electrico-valencia";

const whatsappTextEs =
  "Hola, necesito instalar un toldo eléctrico en Valencia. Quiero pedir presupuesto.";
const whatsappTextEn =
  "Hello, I need to install an electric awning in Valencia. I would like to request a quote.";
...
const services = [
  "Instalación de toldo eléctrico en terraza",
  "Instalación de toldo eléctrico en balcón",
  "Montaje de toldo motorizado",
  "Instalación de toldo con mando a distancia",
  "Instalación de motores para toldo",
  "Conexión eléctrica básica cercana",
  "Ajuste de motor y finales de carrera",
...
const included = [
  ...
  "Colocación del toldo eléctrico",
  "Nivelación del conjunto",
  "Conexión eléctrica básica si el punto está preparado",
  "Ajuste básico del motor",
  "Prueba de apertura y cierre",
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Sí. Podemos instalar toldos eléctricos comprados en Leroy Merlin, Bauhaus, Amazon u otra tienda. Lo ideal es enviar fotos del producto, medidas y zona donde se quiere instalar.",
  },
  {
    question: "¿Podéis conectar el toldo eléctrico a la corriente?",
    answer:
      "Sí, si existe un punto eléctrico cercano y preparado. Si hay que crear una nueva línea eléctrica, canaleta o enchufe, se calcula aparte.",
  },
  {
    question: "¿Ajustáis el motor del toldo?",
    answer:
      "Sí. Hacemos el ajuste básico del motor y comprobamos la apertura y cierre. En algunos modelos concretos puede hacer falta seguir el manual del fabricante.",
  },
  {
    question: "¿Instaláis toldos eléctricos con mando a distancia?",
    answer:
      "Sí. Podemos instalar toldos con mando a distancia y comprobar que el mando abre y cierra correctamente.",
  },
  {
    question: "¿Cuánto tarda la instalación de un toldo eléctrico?",
    answer:
      "Normalmente tarda entre 2 y 4 horas, según tamaño del toldo, tipo de pared, altura, accesibilidad y conexión eléctrica.",
  },
  {
  ...
  {
    question: "¿Instaláis sensores de viento o domótica?",
    answer:
      "Si el sensor o sistema domótico viene preparado con el toldo, podemos revisarlo e instalarlo según el caso. Para sistemas complejos, el precio se calcula aparte.",
  },
];
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = isEs
    ...
    : "Electric awning installation in Valencia. Professional mounting, basic electrical connection and motor adjustment. Quote by WhatsApp.";
...
export default async function ElectricAwningPage({ params }: Props) {
  const { locale } = await params;
  const isEs = locale === "es";
  ...
  const jsonLd = [
    ...
    },
    {
      ...
      "@type": "Service",
      name: isEs
        ? "Instalación de toldo eléctrico en Valencia"
        : "Electric awning installation in Valencia",
      serviceType: "Electric awning installation",
      provider: {
        "@type": "LocalBusiness",
        name: "THEVULGO",
      },
    ...
    <main className="min-h-screen bg-white text-slate-950">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          <div>
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-orange-200 bg-white px-4 py-2 text-sm font-medium text-orange-700 shadow-sm">
              ...
              {isEs
                ? "Instalación de toldos eléctricos en Valencia"
                : "Electric awning installation in Valencia"}
            </div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-700">
              {isEs
                ? "Montamos toldos eléctricos y motorizados en terrazas, balcones, patios y fachadas. Instalación segura, nivelada, con conexión eléctrica básica y prueba de funcionamiento."
                : "We install electric and motorized awnings on terraces, balconies, patios and façades. Safe, level installation with basic electrical connection and operation test."}
            </p>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                ...
                <p className="font-semibold">2–4h</p>
                <p className="text-sm text-slate-600">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <Power className="mb-2 h-5 w-5 text-orange-600" />
                <p className="font-semibold">
                  {isEs ? "Motor y mando" : "Motor and remote"}
                </p>
                <p className="text-sm text-slate-600">
                  {isEs ? "Prueba de apertura y cierre" : "Opening and closing test"}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-[1.5rem] bg-slate-950 p-6 text-white">
              ...
              <ul className="mt-6 space-y-4 text-sm leading-6 text-slate-200">
                <li className="flex gap-3">
                  ...
                  {isEs ? "Foto o enlace del toldo eléctrico" : "Photo or link of the electric awning"}
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-orange-300" />
                ...
                <li className="flex gap-3">
                  <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-orange-300" />
                  {isEs
                    ? "Foto del punto eléctrico o enchufe cercano"
                    : "Photo of the electrical point or nearby outlet"}
                </li>
              </ul>
          ...
          {[
            {
              ...
              text: isEs
                ? "Instalamos los soportes correctamente, alineamos el toldo y comprobamos que el conjunto quede firme y seguro."
                : "We install the brackets correctly, align the awning and check that the full system is firm and safe.",
            },
            {
              icon: Plug,
              title: isEs ? "Conexión eléctrica básica" : "Basic electrical connection",
              text: isEs
                ? "Si el punto eléctrico está preparado y cerca, podemos conectar el toldo y comprobar el funcionamiento."
                : "If the electrical point is ready and nearby, we can connect the awning and test operation.",
            },
            {
              icon: ShieldCheck,
              title: isEs ? "Ajuste y prueba" : "Adjustment and test",
              text: isEs
                ? "Probamos apertura, cierre, mando a distancia y ajuste básico del motor según el modelo."
                : "We test opening, closing, remote control and basic motor adjustment depending on the model.",
            },
          ].map((item) => (
            <div
              key={item.title}
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">
              {isEs
                ? "Instalamos toldos eléctricos y motorizados"
                : "We install electric and motorized awnings"}
            </h2>
            <p className="mt-4 text-lg leading-8 text-slate-700">
              {isEs
                ? "Puedes enviarnos fotos por WhatsApp y revisaremos el tipo de toldo, el punto de instalación, el acceso, la pared y la conexión eléctrica disponible."
                : "You can send us photos by WhatsApp and we will check the awning type, installation point, access, wall and available electrical connection."}
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-8 space-y-4">
              {notIncluded.map((item) => (
                ...
                >
                  <Bolt className="mt-0.5 h-5 w-5 shrink-0 text-slate-500" />
                  <span className="text-slate-700">{item}</span>
                </div>
              ))}
            </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              ...
              <p className="mt-4 leading-8 text-slate-300">
                {isEs
                  ? "El precio final depende del tamaño del toldo, peso, tipo de pared, altura, acceso, punto eléctrico, ajuste del motor y si hay que retirar un toldo antiguo."
                  : "The final price depends on awning size, weight, wall type, height, access, electrical point, motor adjustment and whether an old awning needs to be removed."}
              </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                },
                {
                  ...
                  text: isEs
                    ? "Para toldos largos o pesados puede hacer falta ayuda extra, más tiempo o anclaje reforzado."
                    : "Long or heavy awnings may require extra help, more time or reinforced anchoring.",
                },
                {
                  title: isEs ? "Conexión eléctrica" : "Electrical connection",
                  price: isEs ? "según punto" : "depends on point",
                  text: isEs
                    ? "Si ya hay punto cercano preparado, se puede conectar. Si hay que crear línea, va aparte."
                    : "If there is a nearby prepared point, it can be connected. If a new line is needed, it is extra.",
                },
                {
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-4 leading-8 text-slate-700">
              {isEs
                ? "Antes de confirmar la visita, intentamos revisar todo por fotos para evitar sorpresas: tipo de toldo, pared, acceso, medidas y punto eléctrico."
                : "Before confirming the visit, we try to check everything by photos to avoid surprises: awning type, wall, access, measurements and electrical point."}
            </p>
          </div>
            ...
            {[
              {
                ...
                text: isEs
                  ? "Envíanos fotos del toldo, la pared, el balcón o terraza, el punto eléctrico y las medidas aproximadas."
                  : "Send photos of the awning, wall, balcony or terrace, electrical point and approximate measurements.",
              },
              {
                icon: Euro,
              ...
              },
              {
                ...
                text: isEs
                  ? "Fijamos el toldo, conectamos si el punto está preparado, ajustamos el motor y probamos apertura y cierre."
                  : "We fix the awning, connect it if the point is prepared, adjust the motor and test opening and closing.",
              },
            ].map((step) => (
              <div
                key={step.title}
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[1fr_1fr]">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">
                {isEs
                  ? "Instalación de toldos eléctricos en Valencia y alrededores"
                  : "Electric awning installation in Valencia and nearby areas"}
              </h2>
              <p className="mt-4 leading-8 text-slate-700">
                {isEs
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 leading-8 text-slate-700">
            {isEs
              ? "Estas son las dudas más comunes antes de instalar un toldo eléctrico o motorizado en Valencia."
              : "These are the most common questions before installing an electric or motorized awning in Valencia."}
          </p>
        </div>
            ...
            <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
              <div>
                ...
                <h2 className="text-3xl font-bold tracking-tight">
                  {isEs
                    ? "También instalamos toldos manuales y otros trabajos"
                    : "We also install manual awnings and other jobs"}
                </h2>
                <p className="mt-4 leading-8 text-slate-700">
                  {isEs
                    ? "Si además del toldo eléctrico necesitas montar muebles, instalar lámparas, colgar TV, reparar pared o hacer pequeños trabajos de handyman, podemos verlo en la misma visita."
                    : "If besides the electric awning you need furniture assembly, light installation, TV mounting, wall repair or small handyman jobs, we can check it during the same visit."}
                </p>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-3">
            {[
              {
                icon: Zap,
                title: isEs ? "Toldos eléctricos" : "Electric awnings",
                text: isEs
                  ? "Montaje de toldos motorizados con mando, apertura y cierre eléctrico."
                  : "Installation of motorized awnings with remote control, electric opening and closing.",
              },
              {
                icon: Wrench,
                title: isEs ? "Ajustes y revisión" : "Adjustment and check",
                text: isEs
                  ? "Comprobamos soportes, motor, mando y funcionamiento general del sistema."
                  : "We check brackets, motor, remote and general system operation.",
              },
              {
                icon: ShieldCheck,
                title: isEs ? "Trabajo seguro" : "Safe work",
                text: isEs
                  ? "Revisamos acceso, altura y pared antes de confirmar la instalación."
                  : "We check access, height and wall before confirming the installation.",
              },
            ].map((item) => (
              <div
                key={item.title}
      ...
      <section className="bg-slate-950 text-white">
        <div className="mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 lg:px-8">
          ...
          <h2 className="mx-auto max-w-3xl text-3xl font-bold tracking-tight sm:text-4xl">
            {isEs
              ? "¿Necesitas instalar un toldo eléctrico en Valencia?"
              : "Need to install an electric awning in Valencia?"}
          </h2>
          <p className="mx-auto mt-4 max-w-2xl leading-8 text-slate-300">
            {isEs
              ? "Envíanos fotos del toldo, la pared, el punto eléctrico y la zona de instalación. Te responderemos con precio y disponibilidad."
              : "Send us photos of the awning, wall, electrical point and installation area. We will reply with price and availability."}
          </p>
