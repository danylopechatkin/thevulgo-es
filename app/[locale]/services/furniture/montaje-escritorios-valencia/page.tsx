...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${siteUrl}${locale === "es" ? "/es" : ""}/services/furniture/montaje-escritorios-valencia`,
      languages: {
    ...
    openGraph: {
      ...
      url: `${siteUrl}${locale === "es" ? "/es" : ""}/services/furniture/montaje-escritorios-valencia`,
      siteName: "THEVULGO",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: `${siteUrl}${locale === "es" ? "/es" : ""}/services/furniture/montaje-escritorios-valencia`,
      },
    ],
  };
