...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isEs
    ? "Manitas en Patraix Valencia | Reparaciones y Montaje | THEVULGO"
    : "Handyman in Patraix Valencia | Repairs & Installations | THEVULGO";

  const description = isEs
    ? "Servicio de manitas en Patraix Valencia. Montaje de TV, muebles IKEA, estanterías, lámparas, enchufes, pladur, pequeñas reparaciones y mantenimiento."
    : "Handyman service in Patraix Valencia. TV mounting, IKEA furniture assembly, shelves, lights, outlets, drywall, small repairs and maintenance.";
  ...
  return {
    ...
    keywords: isEs
      ? [
          "manitas patraix",
          "manitas patraix valencia",
          "handyman patraix",
          "reparaciones patraix",
          "montaje tv patraix",
          "montaje muebles patraix",
          "instalar lampara patraix",
          "pladur patraix",
          "manitas valencia",
        ]
      : [
          "handyman patraix",
          "handyman patraix valencia",
          "home repairs patraix",
          "tv mounting patraix",
          "furniture assembly patraix",
          "light installation patraix",
          "drywall repair patraix",
          "handyman valencia",
        ],
    robots: {
      index: true,
...
export default async function HandymanPatraixPage({ params }: Props) {
  const { locale } = await params;
  const isEs = locale === "es";
  ...
  const whatsappText = encodeURIComponent(
    isEs
      ? "Hola, necesito un manitas en Patraix Valencia. Quiero pedir presupuesto para una reparación, montaje o instalación."
      : "Hi, I need a handyman in Patraix Valencia. I’d like to request an estimate for a repair, assembly or installation."
  );
  ...
  const moneyLinks = [
    {
      title: isEs ? "Montaje de TV en Patraix" : "TV mounting in Patraix",
      desc: isEs
  ...
  const process = isEs
    ? [
        ["1. Envía fotos", "Muestra el trabajo por WhatsApp con fotos, medidas y ubicación en Patraix."],
    ...
    : [
        ["1. Send photos", "Show the job by WhatsApp with photos, measurements and Patraix location."],
  ...
  const faqs = isEs
    ? [
        {
          q: "¿Cuánto cuesta un manitas en Patraix?",
        ...
        },
        {
          ...
          a: "Sí. Envía fotos, medidas, ubicación en Patraix y una breve descripción. Así podemos preparar herramientas, materiales y una estimación más clara.",
        },
        {
          q: "¿Hacéis trabajos pequeños el mismo día?",
          a: "Cuando hay disponibilidad, sí. Para trabajos urgentes o rápidos en Patraix, envía fotos y ubicación por WhatsApp.",
        },
        {
        ...
        {
          q: "¿Montáis TV en pared en Patraix?",
    ...
    : [
        {
          q: "How much does a handyman in Patraix cost?",
        ...
        },
        {
          ...
          a: "Yes. Send photos, measurements, Patraix location and a short description so we can prepare tools, materials and a clearer estimate.",
        },
        {
          q: "Do you do same-day small jobs?",
          a: "When availability allows, yes. For urgent or quick jobs in Patraix, send photos and location by WhatsApp.",
        },
        {
        ...
        {
          q: "Do you mount TVs on walls in Patraix?",
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "Service",
        "@id": `${pageUrl}#service`,
        name: isEs ? "Manitas en Patraix Valencia" : "Handyman in Patraix Valencia",
        serviceType: isEs ? "Servicio de manitas" : "Handyman services",
        provider: {
          "@id": `${baseUrl}/#localbusiness`,
        },
        areaServed: ["Patraix", "Valencia"],
        url: pageUrl,
        description: isEs
          ? "Servicio de manitas en Patraix Valencia para montaje de TV, muebles, lámparas, enchufes, estanterías, pladur, pequeñas reparaciones, baño, cocina, Airbnb y mantenimiento."
          : "Handyman service in Patraix Valencia for TV mounting, furniture, lights, outlets, shelves, drywall, small repairs, bathroom, kitchen, Airbnb and maintenance.",
        hasOfferCatalog: {
          "@type": "OfferCatalog",
          name: isEs ? "Servicios de manitas en Patraix" : "Handyman services in Patraix",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            "@type": "ListItem",
            position: 3,
            name: isEs ? "Manitas Patraix" : "Handyman Patraix",
            item: pageUrl,
          },
        ],
      },
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
          <div className="max-w-5xl">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-yellow-400 bg-white px-4 py-2 text-sm font-semibold shadow-sm">
              ...
              THEVULGO • Patraix Valencia
            </div>

            <h1 className="text-4xl font-black tracking-tight sm:text-6xl">
              {isEs
                ? "Manitas en Patraix Valencia para reparaciones, montaje e instalaciones"
                : "Handyman in Patraix Valencia for repairs, assembly and installations"}
            </h1>

            <p className="mt-6 max-w-4xl text-lg leading-8 text-neutral-700">
              {isEs
                ? "Servicio de manitas en Patraix para trabajos reales del día a día: montar una TV, instalar estanterías, montar muebles IKEA, cambiar un enchufe, colgar una lámpara, reparar pladur, ajustar puertas o resolver varias tareas pequeñas en una sola visita."
                : "Handyman service in Patraix for real everyday jobs: mounting a TV, installing shelves, assembling IKEA furniture, replacing an outlet, hanging a light, repairing drywall, adjusting doors or solving several small tasks in one visit."}
            </p>
              ...
              {[
                {
                  ...
                  text: isEs ? "Envía fotos de tu vivienda en Patraix y recibe estimación." : "Send photos from Patraix and get an estimate.",
                },
                {
                  icon: ShieldCheck,
        ...
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-yellow-400 bg-yellow-50 px-4 py-1 text-xs font-bold">
              ...
              {isEs ? "Servicios en Patraix" : "Services in Patraix"}
            </div>

            <h2 className="mt-4 text-3xl font-black sm:text-4xl">
              {isEs ? "Servicios de manitas en Patraix" : "Handyman services in Patraix"}
            </h2>

            <p className="mt-4 max-w-4xl text-neutral-700 leading-8">
              {isEs
                ? "Patraix combina viviendas, urbanizaciones, pisos familiares, alquileres, oficinas y comercios que necesitan mantenimiento práctico. THEVULGO ayuda con montaje, reparaciones, instalaciones y pequeños arreglos sin complicar el trabajo."
                : "Patraix combines homes, residential buildings, family apartments, rentals, offices and shops that need practical maintenance. THEVULGO helps with assembly, repairs, installations and small fixes without overcomplicating the job."}
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr]">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black sm:text-4xl">
                {isEs ? "Presupuesto claro para trabajos en Patraix" : "Clear estimate for jobs in Patraix"}
              </h2>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-4 max-w-5xl text-3xl font-black sm:text-4xl">
            {isEs
              ? "Trabajos de manitas para pisos, alquileres y viviendas en Patraix"
              : "Handyman jobs for apartments, rentals and homes in Patraix"}
          </h2>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black sm:text-4xl">
                {isEs ? "Por qué elegir THEVULGO en Patraix" : "Why choose THEVULGO in Patraix"}
              </h2>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black sm:text-4xl">
                {isEs ? "Mantenimiento para pisos y viviendas en Patraix" : "Maintenance for apartments and homes in Patraix"}
              </h2>

              <p className="mt-5 text-lg leading-8 text-neutral-700">
                {isEs
                  ? "Patraix tiene pisos familiares, viviendas modernas, alquileres y apartamentos donde los pequeños problemas deben resolverse rápido: una puerta que no cierra, una lámpara suelta, un enchufe roto, una manilla floja, una balda caída o una pared dañada."
                  : "Patraix has family apartments, modern homes, rentals and apartments where small issues need to be solved quickly: a door that does not close, a loose light, a broken outlet, a loose handle, a fallen shelf or a damaged wall."}
              </p>
            </div>
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr]">
          <div className="rounded-3xl border border-yellow-300 bg-white p-8 shadow-xl">
            ...
            <h2 className="mt-5 text-3xl font-black">
              {isEs ? "Fijaciones seguras en paredes de Patraix" : "Secure fixings on Patraix walls"}
            </h2>
          ...
          <div className="rounded-3xl border border-yellow-300 bg-white p-8 shadow-xl">
            ...
            <p className="mt-4 text-lg leading-8 text-neutral-700">
              {isEs
                ? "Si tienes varias cosas pendientes en Patraix, es mejor enviarlas todas juntas: una lámpara, una estantería, un mueble, una puerta, una reparación de pared o un accesorio de baño."
                : "If you have several pending jobs in Patraix, it is better to send them all together: a light, a shelf, furniture, a door, a wall repair or a bathroom accessory."}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-neutral-200 bg-neutral-50">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="mx-auto mt-4 max-w-5xl text-3xl font-black sm:text-4xl">
              {isEs ? "Manitas cerca de Patraix" : "Handyman near Patraix"}
            </h2>
          </div>
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-yellow-400 bg-yellow-50 px-4 py-1 text-xs font-bold">
              ...
              SEO • handyman Patraix
            </div>

            <h2 className="mt-4 text-3xl font-black sm:text-4xl">
              {isEs ? "Servicio de manitas en Patraix Valencia" : "Handyman service in Patraix Valencia"}
            </h2>
            ...
            <div className="mt-6 space-y-5 text-lg leading-8 text-neutral-700">
              {isEs ? (
                <>
                  <p>
                    Si buscas <strong>manitas en Patraix Valencia</strong>,
                ...
                <>
                  <p>
                    ...
                    <strong>handyman in Patraix Valencia</strong>, THEVULGO
            ...
            <div className="mt-6 space-y-4">
              {(isEs
                ? [
                    ...
                    "Indica dirección o zona de Patraix",
                ...
                : [
                    ...
                    "Mention address or area in Patraix",
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_0.7fr] lg:items-center">
            <div>
              <h2 className="text-3xl font-black sm:text-4xl">
                {isEs ? "¿Necesitas un manitas en Patraix?" : "Need a handyman in Patraix?"}
              </h2>
