...
const areaPages = [
  { slug: "handyman-benimaclet", area: "Benimaclet" },
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isEs
    ? "Manitas en Campanar Valencia | Reparaciones y Montaje | THEVULGO"
    : "Handyman in Campanar Valencia | Repairs & Installations | THEVULGO";

  const description = isEs
    ? "Servicio de manitas en Campanar Valencia. Montaje de TV, muebles IKEA, estanterías, lámparas, enchufes, pladur, pequeñas reparaciones y mantenimiento."
    : "Handyman service in Campanar Valencia. TV mounting, IKEA furniture assembly, shelves, lights, outlets, drywall, small repairs and maintenance.";
  ...
  return {
    ...
    keywords: isEs
      ? [
          "manitas campanar",
          "manitas campanar valencia",
          "handyman campanar",
          "reparaciones campanar",
          "montaje tv campanar",
          "montaje muebles campanar",
          "instalar lampara campanar",
          "pladur campanar",
          "manitas valencia",
        ]
      : [
          "handyman campanar",
          "handyman campanar valencia",
          "home repairs campanar",
          "tv mounting campanar",
          "furniture assembly campanar",
          "light installation campanar",
          "drywall repair campanar",
          "handyman valencia",
        ],
    robots: {
      index: true,
...
export default async function HandymanCampanarPage({ params }: Props) {
  const { locale } = await params;
  const isEs = locale === "es";
  ...
  const whatsappText = encodeURIComponent(
    isEs
      ? "Hola, necesito un manitas en Campanar Valencia. Quiero pedir presupuesto para una reparación, montaje o instalación."
      : "Hi, I need a handyman in Campanar Valencia. I’d like to request an estimate for a repair, assembly or installation."
  );
  ...
  const moneyLinks = [
    {
      title: isEs ? "Montaje de TV en Campanar" : "TV mounting in Campanar",
      desc: isEs
  ...
  const process = isEs
    ? [
        ["1. Envía fotos", "Muestra el trabajo por WhatsApp con fotos, medidas y ubicación en Campanar."],
    ...
    : [
        ["1. Send photos", "Show the job by WhatsApp with photos, measurements and Campanar location."],
  ...
  const faqs = isEs
    ? [
        {
          q: "¿Cuánto cuesta un manitas en Campanar?",
        ...
        },
        {
          ...
          a: "Sí. Envía fotos, medidas, ubicación en Campanar y una breve descripción. Así podemos preparar herramientas, materiales y una estimación más clara.",
        },
        {
          q: "¿Hacéis trabajos pequeños el mismo día?",
          a: "Cuando hay disponibilidad, sí. Para trabajos urgentes o rápidos en Campanar, envía fotos y ubicación por WhatsApp.",
        },
        {
        ...
        {
          q: "¿Montáis TV en pared en Campanar?",
    ...
    : [
        {
          q: "How much does a handyman in Campanar cost?",
        ...
        },
        {
          ...
          a: "Yes. Send photos, measurements, Campanar location and a short description so we can prepare tools, materials and a clearer estimate.",
        },
        {
          q: "Do you do same-day small jobs?",
          a: "When availability allows, yes. For urgent or quick jobs in Campanar, send photos and location by WhatsApp.",
        },
        {
        ...
        {
          q: "Do you mount TVs on walls in Campanar?",
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "Service",
        "@id": `${pageUrl}#service`,
        name: isEs ? "Manitas en Campanar Valencia" : "Handyman in Campanar Valencia",
        serviceType: isEs ? "Servicio de manitas" : "Handyman services",
        provider: {
          "@id": `${baseUrl}/#localbusiness`,
        },
        areaServed: ["Campanar", "Valencia"],
        url: pageUrl,
        description: isEs
          ? "Servicio de manitas en Campanar Valencia para montaje de TV, muebles, lámparas, enchufes, estanterías, pladur, pequeñas reparaciones, baño, cocina, Airbnb y mantenimiento."
          : "Handyman service in Campanar Valencia for TV mounting, furniture, lights, outlets, shelves, drywall, small repairs, bathroom, kitchen, Airbnb and maintenance.",
        hasOfferCatalog: {
          "@type": "OfferCatalog",
          name: isEs ? "Servicios de manitas en Campanar" : "Handyman services in Campanar",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            "@type": "ListItem",
            position: 3,
            name: isEs ? "Manitas Campanar" : "Handyman Campanar",
            item: pageUrl,
          },
        ],
      },
    ...
    <main className="bg-white text-neutral-950">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
          <div className="max-w-5xl">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-yellow-400 bg-white px-4 py-2 text-sm font-semibold shadow-sm">
              ...
              THEVULGO • Campanar Valencia
            </div>

            <h1 className="text-4xl font-black tracking-tight sm:text-6xl">
              {isEs
                ? "Manitas en Campanar Valencia para reparaciones, montaje e instalaciones"
                : "Handyman in Campanar Valencia for repairs, assembly and installations"}
            </h1>

            <p className="mt-6 max-w-4xl text-lg leading-8 text-neutral-700">
              {isEs
                ? "Servicio de manitas en Campanar para trabajos reales del día a día: montar una TV, instalar estanterías, montar muebles IKEA, cambiar un enchufe, colgar una lámpara, reparar pladur, ajustar puertas o resolver varias tareas pequeñas en una sola visita."
                : "Handyman service in Campanar for real everyday jobs: mounting a TV, installing shelves, assembling IKEA furniture, replacing an outlet, hanging a light, repairing drywall, adjusting doors or solving several small tasks in one visit."}
            </p>

            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a href={whatsappHref} className="inline-flex items-center justify-center gap-2 rounded-xl bg-yellow-400 px-6 py-4 font-bold text-black shadow-lg transition hover:scale-105">
                <MessageCircle className="h-5 w-5" />
                {isEs ? "Pedir presupuesto por WhatsApp" : "Request estimate by WhatsApp"}
              </a>

              <Link href={estimateHref} className="inline-flex items-center justify-center gap-2 rounded-xl border border-neutral-300 bg-white px-6 py-4 font-bold shadow-sm transition hover:scale-105">
              ...
              {[
                {
                  ...
                  text: isEs ? "Envía fotos de tu vivienda en Campanar y recibe estimación." : "Send photos from Campanar and get an estimate.",
                },
                {
                  icon: ShieldCheck,
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-yellow-400 bg-yellow-50 px-4 py-1 text-xs font-bold">
              ...
              {isEs ? "Servicios en Campanar" : "Services in Campanar"}
            </div>

            <h2 className="mt-4 text-3xl font-black sm:text-4xl">
              {isEs ? "Servicios de manitas en Campanar" : "Handyman services in Campanar"}
            </h2>

            <p className="mt-4 max-w-4xl text-neutral-700 leading-8">
              {isEs
                ? "Campanar combina viviendas, urbanizaciones, pisos familiares, alquileres, oficinas y comercios que necesitan mantenimiento práctico. THEVULGO ayuda con montaje, reparaciones, instalaciones y pequeños arreglos sin complicar el trabajo."
                : "Campanar combines homes, residential buildings, family apartments, rentals, offices and shops that need practical maintenance. THEVULGO helps with assembly, repairs, installations and small fixes without overcomplicating the job."}
            </p>
          </div>

          <Link href={`/${locale}/handyman-valencia`} className="inline-flex items-center justify-center gap-2 rounded-xl border border-neutral-300 bg-white px-5 py-3 text-sm font-bold shadow-sm transition hover:scale-105">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {moneyLinks.map((item) => (
            <Link key={item.href} href={item.href} className="group rounded-2xl border border-yellow-300 bg-white p-6 shadow-md transition hover:scale-[1.02] hover:shadow-xl">
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr]">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black sm:text-4xl">
                {isEs ? "Presupuesto claro para trabajos en Campanar" : "Clear estimate for jobs in Campanar"}
              </h2>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-4 max-w-5xl text-3xl font-black sm:text-4xl">
            {isEs
              ? "Trabajos de manitas para pisos, alquileres y viviendas en Campanar"
              : "Handyman jobs for apartments, rentals and homes in Campanar"}
          </h2>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black sm:text-4xl">
                {isEs ? "Por qué elegir THEVULGO en Campanar" : "Why choose THEVULGO in Campanar"}
              </h2>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-yellow-400 bg-white px-4 py-1 text-xs font-bold">
                ...
                {isEs ? "Alquileres y viviendas" : "Rentals and homes"}
              </div>

              <h2 className="mt-4 text-3xl font-black sm:text-4xl">
                {isEs ? "Mantenimiento para pisos y viviendas en Campanar" : "Maintenance for apartments and homes in Campanar"}
              </h2>

              <p className="mt-5 text-lg leading-8 text-neutral-700">
                {isEs
                  ? "Campanar tiene pisos familiares, viviendas modernas, alquileres y apartamentos donde los pequeños problemas deben resolverse rápido: una puerta que no cierra, una lámpara suelta, un enchufe roto, una manilla floja, una balda caída o una pared dañada."
                  : "Campanar has family apartments, modern homes, rentals and apartments where small issues need to be solved quickly: a door that does not close, a loose light, a broken outlet, a loose handle, a fallen shelf or a damaged wall."}
              </p>
            </div>
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr]">
          <div className="rounded-3xl border border-yellow-300 bg-white p-8 shadow-xl">
            ...
            <h2 className="mt-5 text-3xl font-black">
              {isEs ? "Fijaciones seguras en paredes de Campanar" : "Secure fixings on Campanar walls"}
            </h2>
          ...
          <div className="rounded-3xl border border-yellow-300 bg-white p-8 shadow-xl">
            ...
            <p className="mt-4 text-lg leading-8 text-neutral-700">
              {isEs
                ? "Si tienes varias cosas pendientes en Campanar, es mejor enviarlas todas juntas: una lámpara, una estantería, un mueble, una puerta, una reparación de pared o un accesorio de baño."
                : "If you have several pending jobs in Campanar, it is better to send them all together: a light, a shelf, furniture, a door, a wall repair or a bathroom accessory."}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-neutral-200 bg-neutral-50">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="mx-auto mt-4 max-w-5xl text-3xl font-black sm:text-4xl">
              {isEs ? "Manitas cerca de Campanar" : "Handyman near Campanar"}
            </h2>
          </div>

          <div className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {areaPages.map((item) => (
              <Link key={item.slug} href={`/${locale}/${item.slug}`} className="group flex items-center justify-between rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm transition hover:border-yellow-400 hover:shadow-md">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-yellow-400 bg-yellow-50 px-4 py-1 text-xs font-bold">
              ...
              SEO • handyman Campanar
            </div>

            <h2 className="mt-4 text-3xl font-black sm:text-4xl">
              {isEs ? "Servicio de manitas en Campanar Valencia" : "Handyman service in Campanar Valencia"}
            </h2>
            ...
            <div className="mt-6 space-y-5 text-lg leading-8 text-neutral-700">
              {isEs ? (
                <>
                  <p>
                    Si buscas <strong>manitas en Campanar Valencia</strong>,
                ...
                <>
                  <p>
                    ...
                    <strong>handyman in Campanar Valencia</strong>, THEVULGO
            ...
            <div className="mt-6 space-y-4">
              {(isEs
                ? [
                    ...
                    "Indica dirección o zona de Campanar",
                ...
                : [
                    ...
                    "Mention address or area in Campanar",
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_0.7fr] lg:items-center">
            <div>
              <h2 className="text-3xl font-black sm:text-4xl">
                {isEs ? "¿Necesitas un manitas en Campanar?" : "Need a handyman in Campanar?"}
              </h2>
