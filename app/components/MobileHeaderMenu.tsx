...
export default function MobileHeaderMenu({ locale }: Props) {
  ...
  const links = [
    { href: `/${locale}/services`, label: isEs ? "Servicios" : "Services", icon: Wrench },
    { href: `/${locale}/handyman-valencia`, label: isEs ? "Manitas" : "Handyman", icon: Wrench },
    { href: `/${locale}/services/instalacion-ventilador-techo-valencia`, label: isEs ? "Ventiladores" : "Ceiling fans", icon: Fan },
        ...
        <div className="fixed inset-x-0 bottom-0 top-[65px] z-50 md:hidden">
          ...
          <div className="relative mx-3 mt-2 overflow-hidden rounded-3xl border border-yellow-300 bg-white p-4 shadow-2xl">
            <div className="mb-3 flex items-center justify-between">
              ...
              <span className="rounded-full bg-yellow-100 px-3 py-1 text-xs font-bold">Valencia</span>
            </div>
