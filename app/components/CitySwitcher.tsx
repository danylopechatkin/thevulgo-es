...
import { marketPathForLocation, marketName, type Market } from "@/lib/cities";
      ...
      {open && (
        ...
        >
          ...
          <p className="px-3 pb-1 pt-3 text-[11px] leading-4 text-neutral-500">
            {locale === "es"
              ? "Verás servicios, disponibilidad y presupuesto para la ciudad elegida."
              : "You’ll see services, availability and estimates for your chosen city."}
          </p>
        </div>
      )}
    </div>
